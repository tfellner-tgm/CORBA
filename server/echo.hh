...
_CORBA_MODULE helloworld

_CORBA_MODULE_BEG

#ifndef __helloworld_mEcho__
#define __helloworld_mEcho__
  class Echo;
  class _objref_Echo;
  class _impl_Echo;
...
_CORBA_MODULE_BEG
  ...
  class Echo :
    public virtual helloworld::_impl_Echo,
    public virtual ::PortableServer::ServantBase
  {
  public:
    virtual ~Echo();

    inline ::helloworld::Echo_ptr _this() {
      return (::helloworld::Echo_ptr) _do_this(::helloworld::Echo::_PD_repoId);
    }
  };
...
inline void
helloworld::Echo::_marshalObjRef(::helloworld::Echo_ptr obj, cdrStream& s) {
